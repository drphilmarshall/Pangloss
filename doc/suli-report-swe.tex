...
Using the presented methodology, (x \# of background sources) background galaxies in a (y*y square deg) subset of the (0,0,0,0) Millennium Simulation foreground catalog (cite where to get data) were generated and lensed by both the ray-traced shear and convergence as well as the \texttt{Pangloss} framework. Both sets of lensed ellipticities were characterized with correlation functions, as well as the intrinsic ellipticities of the sources before lensing.
