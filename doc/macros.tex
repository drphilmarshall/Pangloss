...
\newcommand{\MS}{Millennium Simulation}
...
\newcommand{\tom}[1]{\textcolor{green}{\bf #1}}
...
\def\devided{divided}
\def\truely{truly}
\def\infered{inferred}
\def\correspends{corresponds}
\def\independant{independent}
\def\dependant{dependent}
\def\proceedure{procedure}
\def\propogate{propagate}
\def\propogates{propagates}
\def\succesful{successful}
