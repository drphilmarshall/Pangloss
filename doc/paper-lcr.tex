...
\Sigma_{\rm BMO}(x) = {2\tau^2 \over (\tau^2+1)^2}\left(
...
kappas with those from the ray tracing results. The standard deviation on  
...
to truncate the halos at ten times their virial radius.
