...
for \eg type Ia supernovae by \citet[][]{Holz+Wald1998,Linder+Holz2004} and for high
redshift galaxies by \tom{which paper?} \citet{Loeb} among others. In time delay lens cosmography
the effect can be particularly important. \citet{Suyu++2010} found that  the
...
measurements through the Universe? As \citeauthor{Linder+Holz2004} noted, when inferring
...
\citep{Oguri+Marshall2010} -- but these samples will be image separation-limited,
...
\todo{Tom, Matt}{More needed here. Previous work on environments: Keeton,
Zabludoff,Auger, Momcheva, Wong, others.}
...
external shears and convergences along strong lens lines of sight. \todo{Phil}{More
needed here. Holder \& Schechter, Dalal \& Watson}. \citet{Hilbert++2009}
performed ray-tracing experiments through the Millenium Simulation \citep{Springel++2005}, generating
...
\citep{Fassnact++2011}, and hence an estimate of  $\Pr(\xkappa)$ could be
made. 
...
to be strongly lensed \citep{Gavazzi++2008,Collett++2012a}, the shear scale of dark matter halos
makes a partial alignment -- with the additional structure acting as a weak lens -- 
a near certainty, indeed \citet{Vale+White2003} and \citet{Hilbert++2007} find that there
...
is undetectable from the image positions, shapes and relative fluxes; {\it the mass sheet-degeneracy} \citep{Falco++1985}.
...
precisely from observed time delays \citep{Suyu++2010}.
...
limit. Since we do not observe halo mass directy, we need some way of estimating
...
(see \citet{Wong++2011} for the practicalities of this);
...
\begin{figure}
\includegraphics[width=\columnwidth]{perfectc.eps}
...
We generate a stellar mass for each halo according to the stellar mass--halo mass relation of \citet{Behroozi++2010}. From this stellar mass we simulate 
...
uncertainties: \citet{Wong++2011} attempted to match the shear from strong lens
...
environment. Since \citet{Wong++2011} only reconstructed the local lens group,
...
similar to the reconstructed line of sight. \citet{Suyu++2012b} found that for RXJ1131 combining shear constriants with galaxy number count overdensity, gave a significantly different $\pr(\kappax|\gamma,N_{45})$ copmpared to the PDFfrom number count overdensity alone, $\pr(\kappax|N_{45})$. 
